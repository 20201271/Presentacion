...
|---------|-------------|--------|--------|
| `data_pais` | Nombre del país en inglés (según V-Dem) | Wikipedia | 2018-2024 |
| `vdem_limpio` | Índice de democracia liberal (0–1; mayor = más democrático) | V-Dem v15 (`v2x_libdem`) | 2018-2024 |
| `vdem_limpio` | Control estatal sobre el territorio (0–1; mayor = más control) | V-Dem v15 (`v2svstterr`) | 2018-2024 |
| `gdp_clean` | PIB per cápita promedio en dólares corrientes (USD) | Banco Mundial (`NY.GDP.PCAP.CD`) | 2018–2024 |
| `data_inestabilidad` | Lista de cantidad de Presidentes (durante el 2018-2024) | Wikipedia | 2018-2024 |
